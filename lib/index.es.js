    ...
    if (attachment.data) {
      if (typeof  attachment.data === 'string') {
        return new Promise((resolve, reject) => {
          isFileString(attachment.data, function (isFile) {
            if (isFile) {
...
function HttpPouch(opts, callback) {
    ...
    function fetchAttachments(doc) {
      ...
      function fetch(filename) {
        ...
        return ajaxPromise(opts, {
          ...
          binary: true,
          base64: typeof opts.file === 'string' && opts.file ? false : true,
          file: typeof opts.file === 'string' && opts.file ? opts.file : false,
        }).then(function (file) {
  ...
  api.getAttachment = adapterFun$$1('getAttachment', function (docId, attachmentId, opts, callback) {
    ...
    ajax(opts, {
      method: 'GET',
      url: url,
      base64: opts.file && typeof opts.file === 'string' ? false : true,
      file: opts.file && typeof opts.file === 'string' ? opts.file : false,
      binary: true
    }, callback);
  });
  ...
  api.putAttachment = adapterFun$$1('putAttachment', function (docId, attachmentId, rev, blob, type, callback) {
    ...
    if (typeof blob === 'string') {
      isFileString(blob, function (isFile) {
        if (isFile) {
        ...
        // Add the above updated attachment uri again
        opts.body = blob;
  ...
  api.allDocs = adapterFun$$1('allDocs', function (opts, callback) {
    ...
    ajaxPromise(opts, {
      ...
      // reading as binary is removed, only base64 will be returned
